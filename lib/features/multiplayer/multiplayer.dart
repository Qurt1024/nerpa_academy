...
class SetLangCode extends RoomEvent {
...
class RoomBloc extends Bloc<RoomEvent, RoomState> {
  ...
  String langCode; // mutable — updated via SetLangCode event
  ...
  RoomBloc({
    ...
    on<SetLangCode>((event, _) => langCode = event.langCode);
  }
      ...
      if (_questions.isEmpty) {
        ...
        try {
          _questions = await _contentRepo.fetchQuestionsForLesson(
              room.lessonId, room.subjectId, langCode: langCode);
        } catch (e) {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(),
                  const SizedBox(height: AppDimens.paddingL),
                  Text(context.l10n.joinRoom, style: Theme.of(context).textTheme.headlineMedium),
                  const SizedBox(height: AppDimens.paddingM),
                  Row(
                    children: [
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(hintText: context.l10n.roomCode),
...
class _CreateRoomDialogState extends State<_CreateRoomDialog> {
  ...
  Future<void> _selectSubject(SubjectModel subject) async {
    ...
    try {
      ...
      final l = await _repo.fetchLessonsForSubject(subject.id, langCode: langCode);
